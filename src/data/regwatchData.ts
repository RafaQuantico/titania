...
export const RW_FUENTES = [
  ...
  { id:"F005", nombre:"MAATE — Ministerio del Ambiente Ecuador", url:"https://www.ambienteyenergia.gob.ec/",
    tipo:"Organismo técnico", estado:"activa", pais:"EC",
  ...
  { id:"F006", nombre:"SUIA — Sistema Único de Información Ambiental", url:"http://suia.ambiente.gob.ec/",
...
export const SYSTEM_PROMPT_REGWATCH = `Eres el Asistente de Inteligencia Regulatoria de Centinela Regulatorio MEF, especializado en el marco normativo ecuatoriano relevante para el Ministerio de Economía y Finanzas.
...
export const RW_WELCOME = `Hola. Soy el Asistente de Inteligencia Regulatoria de Centinela Regulatorio MEF.
