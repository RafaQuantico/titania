                  ...
                  <tr>
                    <td style="padding:44px 48px;">
                      ...
                      <p style="margin:0 0 28px 0;font-size:15px;line-height:1.8;color:#475569;">
                        Has sido autorizado como <strong style="color:#1a2f24;">usuario especial</strong> para acceder a la demostración privada de <strong style="color:#1a2f24;">Titania Gov</strong>. Esta es una experiencia exclusiva diseñada para que puedas explorar algunas de las capacidades de nuestra plataforma de inteligencia regulatoria.
                      </p>
