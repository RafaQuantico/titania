            ...
            <div className="relative w-full max-w-lg overflow-hidden rounded-2xl shadow-2xl">
              ...
              <div className="relative z-10 px-8 py-10">
                ...
                {selectedDemo === 'demo01' ? (
                  ...
                  <>
                    <p className="text-white/80 text-sm leading-relaxed mb-6">
                      Estás explorando una versión demostrativa de <span className="text-white font-semibold">Centinela Regulatorio MEF</span>, impulsado por el motor de IA de Titania.
                    </p>
                ...
                <div className="bg-[#1a2f24] border border-emerald-800/50 rounded-xl shadow-2xl p-5 w-72">
                  ...
                  <p className="text-white/70 text-xs leading-relaxed mb-4">
                    {selectedDemo === 'demo01'
                      ...
                      : "Desde aquí accedes a las herramientas de inteligencia regulatoria de Centinela Regulatorio MEF."}
                  </p>
                ...
                <div>
                  ...
                  {isProjectsOpen && (
                    <div className="ml-9 mt-4 flex flex-col gap-3 border-l border-white/20 pl-4 animate-fade-up">
                      ...
                      {selectedDemo === 'demo02' && (
                        <>
                          <div className="text-white/50 text-[10px] uppercase tracking-wider font-bold">⚡ Centinela Regulatorio MEF</div>
                          <button
