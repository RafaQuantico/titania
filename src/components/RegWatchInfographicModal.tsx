            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center relative z-10 gap-8">
              <div className="max-w-3xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-black tracking-tight leading-none">Centinela Regulatorio MEF</h2>
          ...
          <div className="bg-white border-t border-slate-200 p-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="flex items-start gap-2 max-w-2xl">
              ...
              <p className="text-slate-500 text-[10px] leading-relaxed">
                ⚠️ Centinela Regulatorio MEF no automatiza decisiones públicas ni reemplaza el criterio legal o técnico de los funcionarios. <br className="hidden sm:block"/>
